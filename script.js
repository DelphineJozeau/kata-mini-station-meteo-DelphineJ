...
const countryData = document.querySelector("#pays");
...
async function fetchCoordinates() {
    ...
    try {
        ...
        let city = dataNominatim[0].name;
        let country = dataNominatim[0].address.country;
        ...
        countryData.innerHTML =`Pays : ${country}`;
